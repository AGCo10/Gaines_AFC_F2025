const HiringPage = () => {
    ...
    <div className="container" style="height: 400px">
        <div className="row">
            ...
            <div className="col-lg-8 col-sm-8" style="height: 90px"><h2 className="bebas-neue-regular">Are Your
                Pickles... BORING?</h2></div>
            <div className="col-lg-2 col-sm-2" style="height: 90px"></div>
        ...
        <div className="row">
            ...
            <div className="col-lg-8 col-sm-8 background-dull-highlight">
                ...
                <ul>- Flexible work hours and available weekends & holidays (We are closed Thanksgiving & Christmas
                    Day)
                </ul>
